...
| [Gate tracker](docs/gate-tracker.md) | Central live status for measurement, decision, build-phase, and deferred gates |
...
| [Decision log](docs/DECISION_LOG.md) | D001–D012 with context/consequences/revisit conditions |
...
├── gate-tracker.md              # central live gate status
├── dimensions.md                # dimension sheet + measurement pass
├── DECISION_LOG.md              # D001–D012
...
**Current state:** power architecture, solar, 24 V bus, fridge, awning, windows, wall substrate, roof coating, flooring, wall-track mounting, and lighting controls are decided or proposed (D001–D012 + window SKUs), now **web-validated** (2026-06-05 — see the [validation report](docs/research/build-decision-validation.md); 4/7 original decisions carried cautions folded into the gates, plus D010 flooring addendum). What "done" means for the design is now explicit — the **design-freeze checklist** in the [build sheet](docs/juplaya-trailer-context.md#design-freeze--definition-of-done) (10 items: ratifications, track heights, window stations, roof drawing, standoff design, floor plan, flooring, FRP trim, frozen order list). Live blocker status is centralized in the [gate tracker](docs/gate-tracker.md), fed by the **[measurement pass](docs/dimensions.md#-measurement-pass--fill-in-mm-preferred-these-supersede-spec)**.
