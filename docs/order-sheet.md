...
| BUY NOW | 1 lot | Power wiring lugs heat shrink busbars labels loom | $450.00 | $450.00 | Allowance | Covers bench wiring, branch terminations, busbars, adhesive heat shrink, labels, loom, clamps, and spare ferrules. Detailed lengths, AWG, and terminal sizes are in wire-and-termination-order-sheet.md; ancillary-order-sheet.md remains the non-Victron cart index. |
...
| BUY NOW | 1 lot | Lighting branch wire glands sealant heat shrink | $140.00 | $140.00 | Allowance | Exterior branch wiring, penetrations, and fixture/dimmer terminations. Detailed 16/2 and 18/2 lengths plus terminal sizes are in wire-and-termination-order-sheet.md. |
...
Lighting / switches / security remaining subtotal: **$1,531.62**.
