...
\item The MultiPlus-II is en route but not installed. When AC charging is commissioned, combined trailer charging must still be capped at or below the 100 A ComFlex charge limit.
\end{itemize}
...
\item Bench-measure winter-heater glow current before making it part of a simultaneous-load case; the ordered LandAirSea tracker remains a small always-on load.
