...
% Power-flow arrows.
\draw[arr] (groundpv.east) -- (groundmppt.west);
\draw[arr] (groundmppt.east) -- (busGround);
\draw[arr] (roofpv.east) -- (roofmppt.west);
\draw[arr] (roofmppt.east) -- (busRoof);
\draw[arr] (busBattery) -- (battery.west);
\draw[arr] (busVelit) -- (velit.west);
\draw[arr] (busOrion24) -- (orion24.west);
\draw[arr] (busOrion12) -- (orion12.west);
\draw[arr] (orion24.east) -- (19.25,7.55);
...
\draw[arr] (orion12.east) -- (18.85,5.35) -- (18.85,3.55) -- (cab12.west);
\draw[softarr] (battery.east) -- (phase2.west);

\draw[arr] (ps400.east) -- (c1000.west);
