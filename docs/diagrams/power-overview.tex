...
\node[load, text width=5.35cm, minimum height=0.8cm] (controls) at (22.65,7.95)
  {{\bfseries Controls / LandAirSea GPS}\\[-1pt]
   {\scriptsize ordered tracker; \(<\)0.1 A typ.}};
...
\node[phase, text width=3.4cm, minimum height=1.0cm] (phase2) at (22.65,11.35)
  {{\bfseries MultiPlus-II en route}\\[-1pt]
   {\scriptsize built-in AC; location and install gated}};
