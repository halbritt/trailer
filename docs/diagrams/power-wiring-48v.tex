...
\node[note, text width=6.7cm] at (16.2,2.35)
  {\textbf{Cabinet boundary.} Mount to measured wall-post backing. Keep required component orientation and service clearance. Route cables through protected entries. Vent low-to-high back into the cabin. The deferred MultiPlus is not assigned to this shallow cabinet.};
...
\node[font=\sffamily\scriptsize, text=muted, anchor=west] at (0,0)
  {Sources: docs/power.md; D015; official Victron SmartSolar, SmartShunt, Cerbo GX, and Orion documentation. Not an AC or tow-vehicle wiring diagram.};
\end{tikzpicture}
\end{document}
