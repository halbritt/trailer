...
| 21 | **Shallow high-wall power cabinet** — wall station, W x H x D, post/backing fasteners, component clearances, cable entry, service access, switch/receptacle face, intake/exhaust, and temperature-sensor station | TBD — active Victron DC gear, busbars, branch protection, and controls only; deferred MultiPlus excluded | | |
