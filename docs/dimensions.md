...
| 20 | **Street-side battery bench** — wall station, W x H x D, battery orientation, floor/L-track/crossmember anchors, anti-tip tie, main Class-T location, and protected feeder exit | TBD — compact bench on the street-side/roadside V-nose; battery low; main Class-T before the positive feeder leaves the bench | | |
| 21 | **Shallow high-wall power cabinet** — wall station, W x H x D, post/backing fasteners, component clearances, cable entry, service access, switch/receptacle face, intake/exhaust, and temperature-sensor station | TBD — active Victron DC gear, busbars, branch protection, and controls only; incoming MultiPlus excluded and assigned a separate location | | |
...
> When a row is filled, propagate: the roof drawing (4–6, 15), solar rail/backing detail, window cuts (7, 12–14), riser fabrication (8, 9, 16), floor L-track layout (10, 11), the payload ledger (18), and the split power-enclosure drawing plus final wire cuts (20–21).
