...
| G08 Wall substrate | Open | Factory panel thickness is closed; still ratify D009 | Birch/FRP buy, window sandwich, wall closure | [DECISION_LOG.md](DECISION_LOG.md) D009; [dimensions.md](dimensions.md) row 19 |
| G09 Decision ratification | Open | Owner ratifies D006-D008 and D012; D009 ratification is tracked in G08 | Design freeze, order freeze, strip-out | [DECISION_LOG.md](DECISION_LOG.md) D006-D009/D012 |
...
| C11 Factory wall panel thickness | Closed | Factory wall panels are verified 3/8 in | D009 still needs owner ratification | [dimensions.md](dimensions.md) row 19 |
