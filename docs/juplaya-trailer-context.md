...
- **Substrate sourcing (corrected 2026-06-05):** the on-hand birch is a **single interior-grade sheet — NOT wall-eligible** (interior glue fails the waterproof line), so **buy the substrate.** Use **3/8" BC sanded pine, Exposure-1/exterior glue line** (Home Depot **Plytanium 721715**, 11/32"≈3/8"; sanded B-face toward the FRP so it doesn't telegraph). **Not** the 3/8" *pressure-treated* BCX (wet + chemically treated → FRP won't bond). **Not** Sande ply (interior/unreliable glue). The opaque FRP hides the substrate, so face looks are irrelevant here — **repurpose the nice interior birch for a visible, dry interior fixture** (nose-cabinet face/shelving), not the walls.
- **Reuse option (cheapest path — decide off row 19):** the factory wall board comes off for foam anyway, so it *could* go back up as the FRP substrate. **The material decides it** — row 19 says "OSB *assumed*," not confirmed. **If it's a PlexCore-type composite (not wood-strand) and survives removal intact → reuse it** (free, pre-sized, composite is moisture-stable). **If it's true OSB → don't** — OSB strands swell irreversibly and lose strength when wet and bond FRP poorly (waxy/rough, telegraphs); behind a sealed, uninspectable skin that resurrects the moisture hazard to save ~$30/sheet, so buy BC pine instead. Either way, seal old fastener holes/wiring cutouts and cut out any swollen/stained areas. **Pull one panel early to ID the board.**
...
| 9 | **FRP trim system** | corner/seam/edge/reveal profiles + adhesive picked (color-matched vinyl moldings; FRP adhesive warranted on birch — web-val). **Candidate set:** HD Glasliner PVC trim (division bar 9290NL / inside 9350NL / outside 99400NL / end cap 9460XA) + Titebond Fast Grab 4059 — laminated in place over screwed-down 3/8" ply (screwless finish) | ☐ |
