...
10. **Nose cabinet** — battery, SmartSolar, shunt, breaker, Orion-Tr 48/24, Orion-Tr 48/12, 5026, fused 12 V receptacles; rail wiring out to branches; cabinet venting with low filtered intake, high RecPro RP-2414 exhaust, 24 V fan, and temperature switch. MultiPlus mounting space can be reserved for Phase 2, but it is not a Juplaya install dependency.
