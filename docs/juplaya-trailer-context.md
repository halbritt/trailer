...
- **Incoming:** Victron MultiPlus-II 48/3000/35-50 120V is en route as of 2026-07-10. Its physical location remains open, and it does not belong in the shallow active-equipment cabinet. The 48 V install diagram models its protected DC branch, required disconnect, VE.Bus link, and AC interfaces.
...
- **No insulation or finish walls are installed yet.** Closed-cell spray foam remains planned for the wall and ceiling cavities. The Henry 887 exterior roof coating was completed by owner report on 2026-07-10.
...
The Henry 887 roof coating is complete, but the structural roof repair remains open. Updated sequence: wash and inspect -> measure the as-built array overhang and Velit opening -> remove the Velit -> remove/protect coating around the hot-work zone -> add longitudinal opening reinforcement and dry-fit the crown/drainage detail -> corrosion-protect, reseal, and hose-test -> clean and restore the disturbed Henry 884/887 system -> close the roof drawing -> foam. Build sheet: [solar_mounting.md](solar_mounting.md). Full research and gates: [solar mounting backing note](research/solar-panel-mounting-backing-2026-06-06.md).
...
**Status:** completed by owner report on 2026-07-10. Completion does not close the Velit structural repair. Strip or positively shield silicone near welding, restore corrosion protection and the Henry 884/887 system afterward, and repeat the hose test before foam or ceiling closure. Henry explicitly permits recoating previously coated roofs and requires a clean, dry surface with defects and penetrations repaired before coating.
...
Why these spots survive every other system: the 12" cutout fits **inside one 16"-OC post bay (~14.5" clear) — no post gets cut, no sub-frame needed.** The 36–58" window band sits between the bed track (~27") and the shelf track (60"). **Exact window stations are TBD.** The bikes now sit **toward the rear with the handlebars sweeping over the curbside fridge zone** (this supersedes the earlier "bars live in the front half" read); the bars stop short of the wall plane, so the rear bed-zone pair is still expected to clear — confirmed by the in-trailer bike check (row 11) and the bay-width gate (row 7).
...
- **WR250R + CRF450RL (~590 lb pair), side-by-side, nose-forward, straddling the centerline (one L-track row roadside, one curbside, ~26" off each wall) and set toward the rear (rear wheels near the ramp) — so the curbside bike's handlebars sweep over the fridge bay** (clear at bar height over the 18.6" fridge), in **ordered Bolt It On 360 L-track wheel chocks** (12–18" stagger so the bars interleave). Floor geometry: **two lengthwise floor L-track rows, 26" on center** (one each side of the centerline), flush/recessed and bolted through to steel/backing; the 4 factory D-rings get reused as backup tie points. Primary motorcycle crash restraint stays on the floor L-track and factory 5,000 lb D-rings tied to the steel frame/crossmembers, not on the wall E-track.
...
- **Switch/dimmer hardware:** use **Blue Sea 8260 6-position Contura mounting panel + 6x Blue Sea 8282 SPST OFF-ON black Contura switches** labeled INTERIOR, CURB FLOOD, ROAD FLOOD, NOSE FLOOD, REAR FLOOD, AWNING. The 8260 panel needs <=0.38" mounting thickness, so use a thin inset plate or rabbet a thicker cabinet face. Preferred finished dimmer is **6x panel-mount 24 V dimmer controls**, exact SKU TBD after cabinet-panel mockup. Blue Sea 7509 DeckHand is the robust 24 V / 12 A marine reference; cheap PWM knob dimmers such as `LDK-8A` remain acceptable bench-test/prototype parts.
- **Dimming gate:** bench-test one ordered `VAL2-NW9` flood/scene fixture with the selected panel dimmer before final exterior mounting. Its public specs confirm 12-28 VDC, 18 W, and 1.5 A, but do not explicitly say dimmable. If it flickers, buzzes, shuts down, or runs hot, keep that exterior side switch-only or change to a dimmable exterior fixture.
...
- **Long-lead / remaining:** return LiTime 5 kW; **MultiPlus-II en route, with location and install hardware still gated** · Fiamma F45s 350 + Tie Down S + lag anchors/deadman bags · active Victron gear · 250 V-class roof PV disconnect/OCP · Blue Sea 7443 20 A / 80 V DC UL-489 breaker · **shallow-cabinet interior transfer grille/filter + 24 V cabinet fan + normally-open thermostat** · standoff + backing steel stock (owner fab) · battery-bench restraint/anchors · positive-closing travel covers for unused exterior vents.
...
6. **Roof coating restoration** — the main Henry 887 application is complete; after the Velit reinforcement and hose test, clean and restore every area disturbed by welding, corrosion protection, curb work, or resealing.
...
| 10 | **G12 split power enclosure** — compact street-side battery bench plus shallow high active-equipment cabinet | rows 20/21 measured; anchors/backing, component fit, service clearances, protected feeder route, ventilation, controls, and separate incoming MultiPlus disposition drawn and dry-fit | ☐ |
| 11 | **Order list frozen** — every remaining SKU, including all wiring protection shown in the install diagrams, roof repair stock, travel vent closures, battery-bench hardware, shallow-cabinet ventilation/control parts, and finish materials. MultiPlus-II install hardware follows its still-open placement gate. | rows 1–10 closed | ☐ |
