...
Date: 2026-06-14. Itemized breakout for the non-Victron electrical and control hardware in [order-sheet.md](order-sheet.md). Spec sources: [power.md](power.md), [wire-and-termination-order-sheet.md](wire-and-termination-order-sheet.md), and [juplaya-trailer-context.md](juplaya-trailer-context.md).
...
| 1 lot | Power wiring, lugs, adhesive heat shrink, busbars, labels, loom, clamps | $450.00 | $450.00 | Allowance | Detailed lengths, AWG, and terminal sizes are broken out in [wire-and-termination-order-sheet.md](wire-and-termination-order-sheet.md); dry-fit before final cuts. |
